...
const AddressForm = (props) =>{
    ...
    const renderAddreeForm = () =>{
        return(
            <>
                <div className = "flaxeRow">
    ...
    if(props.withoutLayout){
        return <div>{renderAddreeForm}</div>;
    }
    return (
        <div className="checkoutStep" style = {{ background : "#f5aff"}}>
