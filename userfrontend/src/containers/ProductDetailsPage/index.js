...
//function for productDetailsPage
...
return (
     <layout>
        <div className="productDescriptionContainer">
            <div claaName="flexRow">
                    <div className="verticalImageStack">
                        {
                              product.productDetails.productPictures.map((thumb, index) =>
                              <div className="thumbnail">
                                  <image src={generatePublicUrl(thumb.img)} alt={thumb.img} />
                              </div>
                          )
                        }
                     
                        <div className="productDexcContainer">
                    ...
                    <div className="productDetails">
                        ...
                        <div>
                            ...
                            <span className="ratingNumberReviews">72,234 Ratings & 8,250 Reviews</span>
                        </div>
                       
                        <div className="flexRow priceContainer">
                            <span className="price">{product.productDetails.price}</span>
                            <span claaName="discount" style={{ margin: '0 10px' }}>25% off</span>
                        </div>
                        <div>
                            <p style={{
                                color: "#121212",
